...
import Script9 from "../a72de884-e275-490d-b1bb-7f7eaca4777f/src/item"
import Script10 from "../6ef2baf2-3d2e-4093-b22b-34c2b6bb0e7b/src/item"
import Script11 from "../6c75f42f-03c6-430c-b49d-b7b37c1e0c3d/src/item"
import Script12 from "../683aa047-8043-40f8-8d31-beb7ab1b138c/src/item"
import Script13 from "../1ab2733f-1782-4521-9eda-6aa8ad684277/src/item"
import Script14 from "../0764e129-9fff-4158-98f0-6db8665dcf7b/src/item"
import Script15 from "../12b03cb6-2066-4f72-b8ef-27bb851de48e/src/item"
import Script16 from "../f89ab04f-46ef-42ea-912b-b194eb8d2f02/src/item"
import Script17 from "../8186a12c-d2ef-4f9d-96b9-cc2dd87567d1/src/item"
import Script18 from "../d5ee9a47-8484-4824-a609-996298830b51/src/item"
...
const transform7 = new Transform({
  position: new Vector3(22.40198516845703, 11.804352760314941, 29.734146118164062),
...
const transform26 = new Transform({
  ...
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(2.2192492485046387, 1.5180683135986328, 1.8861253261566162)
})
...
const transform34 = new Transform({
  position: new Vector3(19.719768524169922, 4.260398864746094, 27.553401947021484),
  rotation: new Quaternion(7.447551747112217e-17, 0.6932232975959778, -8.263864970103896e-8, -0.7207229137420654),
  scale: new Vector3(3.6052193641662598, 2.3040549755096436, 5.701797962188721)
})
invisibleRamp.addComponentOrReplace(transform34)

const invisibleWall2 = new Entity('invisibleWall2')
engine.addEntity(invisibleWall2)
invisibleWall2.setParent(_scene)
const transform35 = new Transform({
  position: new Vector3(21.147335052490234, 11.88502311706543, 27.262893676757812),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(4.601300239562988, 0.987927258014679, 3.9028515815734863)
})
invisibleWall2.addComponentOrReplace(transform35)
...
imageScreen.addComponentOrReplace(transform36)
...
wallPlainRed3.addComponentOrReplace(transform38)
...
wallPlainRed4.addComponentOrReplace(transform39)
...
wallPlainRed5.addComponentOrReplace(transform40)
...
wallPlainRed6.addComponentOrReplace(transform41)
...
wallPlainWhite3.addComponentOrReplace(transform42)
...
wallPlainWhite5.addComponentOrReplace(transform43)
...
floorGrey.addComponentOrReplace(transform44)
...
floorGrey2.addComponentOrReplace(transform45)
...
plainText7.addComponentOrReplace(transform46)
...
dropChandelier4.addComponentOrReplace(transform47)
...
dropChandelier2.addComponentOrReplace(transform48)
...
wallPlainRed8.addComponentOrReplace(transform49)
...
imageFromURL15.addComponentOrReplace(transform50)
...
qrDonationsBanner.addComponentOrReplace(transform51)
...
imageFromURL4.addComponentOrReplace(transform52)
...
imageFromURL14.addComponentOrReplace(transform53)
...
qrDonationsBanner3.addComponentOrReplace(transform54)
...
imageFromURL16.addComponentOrReplace(transform55)
...
qrDonationsBanner4.addComponentOrReplace(transform56)
...
imageScreen3.addComponentOrReplace(transform57)
...
wallPlainRed9.addComponentOrReplace(transform58)
...
imageFromURL13.addComponentOrReplace(transform59)
...
imageFromURL11.addComponentOrReplace(transform60)
...
wallPlainGlass6.addComponentOrReplace(transform61)
...
wallPlainGlass8.addComponentOrReplace(transform62)
...
wallPlainRed10.addComponentOrReplace(transform63)
...
plainText8.addComponentOrReplace(transform64)
...
plainText9.addComponentOrReplace(transform65)
...
plainText10.addComponentOrReplace(transform66)
...
wallPlainRed11.addComponentOrReplace(transform67)
...
imageFromURL17.addComponentOrReplace(transform68)
...
imageFromURL18.addComponentOrReplace(transform69)
...
imageScreen4.addComponentOrReplace(transform70)
...
wallPlainWhite6.addComponentOrReplace(transform71)
...
wallPlainWhite8.addComponentOrReplace(transform72)
...
wallPlainWhite10.addComponentOrReplace(transform73)
...
wallPlainWhite4.addComponentOrReplace(transform74)
...
fridgeCounter.addComponentOrReplace(transform75)
...
wallPlainRed12.addComponentOrReplace(transform76)
...
plainText3.addComponentOrReplace(transform77)
...
floorWood2.addComponentOrReplace(transform78)
...
toolbox.addComponentOrReplace(transform79)
...
triggerArea.addComponentOrReplace(transform80)

const invisibleWall3 = new Entity('invisibleWall3')
engine.addEntity(invisibleWall3)
invisibleWall3.setParent(_scene)
const transform81 = new Transform({
  position: new Vector3(21.147335052490234, 11.741068840026855, 27.262893676757812),
  rotation: new Quaternion(0, 0, 0, 1),
...
scifiLever.addComponentOrReplace(transform82)
...
triggerArea2.addComponentOrReplace(transform84)
...
scifiLever2.addComponentOrReplace(transform85)
...
plainText2.addComponentOrReplace(transform86)
...
wallPlainWhite7.addComponentOrReplace(transform87)
...
imageFromURL20.addComponentOrReplace(transform88)
...
imageFromURL22.addComponentOrReplace(transform89)
...
facebookButtonLink.addComponentOrReplace(transform90)
...
wallPlainWhite11.addComponentOrReplace(transform91)
...
twitterButtonLink2.addComponentOrReplace(transform92)
...
wallPlainWhite12.addComponentOrReplace(transform93)
...
youtubeButtonLink.addComponentOrReplace(transform94)
...
instagramButtonLink.addComponentOrReplace(transform95)
...
imageFromURL27.addComponentOrReplace(transform96)
...
imageFromURL28.addComponentOrReplace(transform97)
...
imageFromURL23.addComponentOrReplace(transform98)
...
imageFromURL24.addComponentOrReplace(transform99)
...
imageFromURL25.addComponentOrReplace(transform100)
...
wallPlainWhite2.addComponentOrReplace(transform101)
...
plainText6.addComponentOrReplace(transform102)
...
plainText5.addComponentOrReplace(transform103)
...
wallPlainRed7.addComponentOrReplace(transform104)
...
plainText11.addComponentOrReplace(transform105)
...
plainText12.addComponentOrReplace(transform106)
...
const transform107 = new Transform({
  position: new Vector3(7.743481636047363, 0, 27.553401947021484),
  rotation: new Quaternion(7.447551747112217e-17, 0.6932232975959778, -8.263864970103896e-8, -0.7207229137420654),
  scale: new Vector3(3.5896189212799072, 1.0197654962539673, 1.002964735031128)
})
invisibleRamp2.addComponentOrReplace(transform107)
...
script8.spawn(verticalPlatform, {"distance":5,"speed":5,"autoStart":false,"onReachEnd":[{"entityName":"verticalPlatform","actionId":"goToStart","values":{}}],"onReachStart":[{"entityName":"verticalPlatform","actionId":"goToEnd","values":{}}]}, createChannel(channelId, verticalPlatform, channelBus))
...
script9.spawn(invisibleRamp, {"enabled":true}, createChannel(channelId, invisibleRamp, channelBus))
script5.spawn(invisibleWall2, {"enabled":true}, createChannel(channelId, invisibleWall2, channelBus))
script10.spawn(imageScreen, {"image":"https://bafybeie7kcyawd4irgmgmkzltojmzrcbnffdq3ptl73wukonzzk6u4mzjy.ipfs.dweb.link/UNI_Mob_ExpCounselor.jpg"}, createChannel(channelId, imageScreen, channelBus))
...
script11.spawn(qrDonationsBanner, {"publicKey":"","text":"IDFC First Bank","fontSize":10}, createChannel(channelId, qrDonationsBanner, channelBus))
...
script11.spawn(qrDonationsBanner3, {"publicKey":"","text":"IDFC First Bank","fontSize":10}, createChannel(channelId, qrDonationsBanner3, channelBus))
...
script11.spawn(qrDonationsBanner4, {"publicKey":"","text":"IDFC First Bank","fontSize":10}, createChannel(channelId, qrDonationsBanner4, channelBus))
script10.spawn(imageScreen3, {"image":"https://i.imgur.com/d25gO61.jpg"}, createChannel(channelId, imageScreen3, channelBus))
...
script10.spawn(imageScreen4, {"image":"https://bafybeie7kcyawd4irgmgmkzltojmzrcbnffdq3ptl73wukonzzk6u4mzjy.ipfs.dweb.link/UNI_Mob_ExpCounselor.jpg"}, createChannel(channelId, imageScreen4, channelBus))
...
script15.spawn(facebookButtonLink, {"url":"https://www.facebook.com/idfcfirstbank/","bnw":false,"name":"IDFC First Bank"}, createChannel(channelId, facebookButtonLink, channelBus))
script16.spawn(twitterButtonLink2, {"url":"https://twitter.com/IDFCFIRSTBank","bnw":false,"name":"IDFC First Bank"}, createChannel(channelId, twitterButtonLink2, channelBus))
script17.spawn(youtubeButtonLink, {"url":"https://www.youtube.com/channel/UC3fyk0wieN6OdUIO-FARXDA","bnw":false,"name":"IDFC First Bank"}, createChannel(channelId, youtubeButtonLink, channelBus))
script18.spawn(instagramButtonLink, {"url":"https://www.instagram.com/idfcfirstbank/?hl=en","bnw":false,"name":"IDFC First Bank"}, createChannel(channelId, instagramButtonLink, channelBus))
...
script9.spawn(invisibleRamp2, {"enabled":true}, createChannel(channelId, invisibleRamp2, channelBus))